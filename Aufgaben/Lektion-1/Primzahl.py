...
def istPrimzahl(nummer):
    # Überprüft, ob die Zahl größer als Eins ist. Jede kleinere Zahl ist keine Primzahl.
    if nummer > 1:
...
def zaehlePrimzahl(n):
    anzahlPrimzahlen = 0
    # Beginnt bei 1 mit der Funktion, zum Überprüfen, ob die Zahl eine Primzahl ist.
    nummer = 1
